...
{
    public const string MAVLINK_BUILD_DATE = "Mon May 07 2018";
    ...
    public static readonly message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
		...
		new message_info(187, "DA_GPS_STA", 93, 26, 26, typeof( mavlink_da_gps_sta_t )),
		new message_info(188, "DA_GPS2_STA", 5, 26, 26, typeof( mavlink_da_gps2_sta_t )),
		new message_info(190, "GCS_CAPABILITIES", 197, 8, 8, typeof( mavlink_gcs_capabilities_t )),
		...
		new message_info(225, "STATION_STATUS", 144, 7, 7, typeof( mavlink_station_status_t )),
		new message_info(226, "RPM", 207, 8, 8, typeof( mavlink_rpm_t )),
		new message_info(228, "PAYLOAD_STATUS", 73, 13, 13, typeof( mavlink_payload_status_t )),
		new message_info(229, "FLIGHT_TIME_THISMAV", 249, 12, 12, typeof( mavlink_flight_time_thismav_t )),
...
AOA_SSA = 11020,
    ...
    public enum MAV_CMD: ushort
    {
        ...
        DO_SET_REVERSE=194, 
    	///<summary> Send base station coordinates. |Empty| Empty| Empty| Empty| x the location of the base station.| y the location of the base station.| Empty|  </summary>
        RECEIVE_STA_POS=195, 
    	///<summary> Set the base station coordinates. |Empty| Empty| Empty| Empty| x the location of the base station.| y the location of the base station.| Empty|  </summary>
        SET_STA_POS=196, 
    	...
    	///<summary> AUX_PIN_CONTROL |AUX0_VALUE| AUX1_VALUE| AUX2_VALUE| AUX3_VALUE| AUX4_VALUE| AUX5_VALUE| Empty|  </summary>
        DO_AUX_CONTROL=227, 
    	///<summary> do sprayer |switch, 1 switch on the sprayer, 0 switch off the sprayer| Empty| Empty| Empty| Empty| Empty| Empty|  </summary>
        DO_SPRAYER=239, 
        ...
        MISSION_START=300, 
    	///<summary> start running a mission |auth_id0: 	the first id| auth_id1:  the second id| auth_id2:  the third id|  </summary>
        AUTH_PROTOCAL=350, 
    	///<summary> AB mission plan switch |switch: AB mission switch|  </summary>
        ABMISSION=352, 
    	...
    	///<summary> Send base station coordinates. |direction| waypoint index| Empty| Empty| x the location of the waypoint.| y the location of the waypoint.| z the location of the waypoint.|  </summary>
        SEND_ABMODE_POS=450, 
    	...
    	///<summary> Open the charging station cover |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  </summary>
        OPEN_COVER=45000, 
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=8)]
    ///<summary> GCS capabilities </summary>
    public struct mavlink_gcs_capabilities_t
    {
        /// <summary>  </summary>
        public  uint capabilities;
            /// <summary> Communication drops in percent, dropped packets on telecommunication links </summary>
        public  float dropped_packets;
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=7)]
    ///<summary> The state of the charging station when the UAV communicates with the charging station </summary>
    public struct mavlink_station_status_t
    {
        /// <summary> The countdown (milliseconds) </summary>
        public  ushort Countdown_time;
            /// <summary> the charging station status(0:closed,1:open) </summary>
        public  byte station_status;
            /// <summary> The contents of this operation(0:nothing,1:Open the charging station cover) </summary>
        public  byte command;
            /// <summary> This command status(0:nothing,1:Communicating,2:Request to open the cover,3:Opening the cover,4:Has been opened,5:The takeoff is complete) </summary>
        public  byte command_status;
            /// <summary> The result of this command(0:processing,1:success,2:failure,3:time out) </summary>
        public  byte command_result;
            /// <summary> Number of remaining retransmissions </summary>
        public  byte command_repeat;
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=13)]
    ///<summary> payload status of this mav </summary>
    public struct mavlink_payload_status_t
    {
        /// <summary> FMU system time in millisecond </summary>
        public  uint system_time_ms;
            /// <summary> payload status of this message indicate, 0: Disabel, 1: FlowMeter </summary>
        public  byte payload_type;
            /// <summary> payload_status_byte0 </summary>
        public  byte payload_status0;
            /// <summary> payload_status_byte1 </summary>
        public  byte payload_status1;
            /// <summary> payload_status_byte2 </summary>
        public  byte payload_status2;
            /// <summary> payload_status_byte3 </summary>
        public  byte payload_status3;
            /// <summary> payload_status_byte4 </summary>
        public  byte payload_status4;
            /// <summary> payload_status_byte5 </summary>
        public  byte payload_status5;
            /// <summary> payload_status_byte6 </summary>
        public  byte payload_status6;
            /// <summary> payload_status_byte7 </summary>
        public  byte payload_status7;
    
    };


    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    ///<summary> Flight time of this mav </summary>
    public struct mavlink_flight_time_thismav_t
    {
        /// <summary> FMU system time in millisecond </summary>
        public  uint system_time_ms;
            /// <summary> flignt time in second since last armmed </summary>
        public  uint local_flight_time_secs;
            /// <summary> total flight time of this mav in hours </summary>
        public  ushort flight_time_hours;
            /// <summary> total flight time of this mav in second[0 3600) </summary>
        public  ushort flight_time_secs;
    ...
    ///<summary> Dual antenna GPS output status </summary>
    public struct mavlink_da_gps_sta_t
    {
        /// <summary> Timestamp (micros since boot or Unix epoch) </summary>
        public  ulong time_usec;
            /// <summary> Directional value </summary>
        public  float heading_data;
        ...
        public  float param2;
            /// <summary> reserve </summary>
        public  float param3;
            /// <summary> Directional value status </summary>
        public  byte hd_status;
            /// <summary> EKF2 heading mode,0:Magnetic compass;1:Dual antenna GPS heading;0xff:Reserved, unused </summary>
        public  byte ek2_h_mode;
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=26)]
    ///<summary> Dual antenna GPS output status </summary>
    public struct mavlink_da_gps2_sta_t
    {
        /// <summary> Timestamp (micros since boot or Unix epoch) </summary>
        public  ulong time_usec;
            /// <summary> Directional value </summary>
